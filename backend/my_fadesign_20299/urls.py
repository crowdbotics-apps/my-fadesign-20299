"""my_fadesign_20299 URL Configuration
...
admin.site.site_header = "My FaDesign"
admin.site.site_title = "My FaDesign Admin Portal"
admin.site.index_title = "My FaDesign Admin"

# swagger
api_info = openapi.Info(
    title="My FaDesign API",
    default_version="v1",
    description="API documentation for My FaDesign App",
)
